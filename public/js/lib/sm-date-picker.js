+function($) {
    ...
    t = function(e, a) {
        ...
        for (var t = new Date(e).getFullYear(), n = new Date(a).getFullYear(), l = [], s = t; s <= n; s++) l.push(s);
        return l
    },
    n = function(e) {
        ...
        return t < n && (e.cols[0].setValue(e.params.minDate.split("-")[0]), e.cols[1].setValue(e.params.minDate.split("-")[1]), a = e.params.minDate),
        t > l && (e.cols[0].setValue(e.params.maxDate.split("-")[0]), e.cols[1].setValue(e.params.maxDate.split("-")[1]), a = e.params.maxDate),
        a
    },
    l = {
        change: null,
...
function($) {
    ...
    var e = new Date,
    a = function(e) {
        for (var a = [], t = 1; t <= (e || 31); t++) a.push(t < 10 ? "0" + t: t);
        return a
    },
    t = function(e, t) {
    ...
    s = function(e, a) {
        for (var t = new Date(e.replace(new RegExp("-", "gm"), "/")).getFullYear(), n = new Date(a.replace(new RegExp("-", "gm"), "/")).getFullYear(), l = [], s = t; s <= n; s++) l.push(s);
        return l
    },
    i = function(e) {
        ...
        return s < i && (e.cols[0].setValue(e.params.minDate.split("-")[0]), e.cols[1].setValue(e.params.minDate.split("-")[1]), e.cols[2].setValue(e.params.minDate.split("-")[2]), l = e.params.minDate),
        s > r && (e.cols[0].setValue(e.params.maxDate.split("-")[0]), e.cols[1].setValue(e.params.maxDate.split("-")[1]), e.cols[2].setValue(e.params.maxDate.split("-")[2]), l = e.params.maxDate),
        l
    },
    r = {
        change: null,
...
function($) {
    ...
    t = function(e) {
        ...
        return t < n && (e.cols[0].setValue(e.params.minTime.split(":")[0]), e.cols[2].setValue(e.params.minTime.split(":")[1]), a = e.params.minTime),
        t > l && (e.cols[0].setValue(e.params.maxTime.split(":")[0]), e.cols[2].setValue(e.params.maxTime.split(":")[1]), a = e.params.maxTime),
        a
    },
    n = {
        change: null,
    ...
    $.fn.timePicker = function(e) {
        return this.each(function() {
            if (this) {
                ...
                t.cols = [{
                    values: function() {
                        for (var e = [], a = 0; a <= 23; a++) e.push(a < 10 ? "0" + a: a);
                        return e
                    } ()
                },
                {
                ...
                {
                    values: function() {
                        for (var e = [], a = 0; a <= 59; a++) e.push(a < 10 ? "0" + a: a);
                        return e
                    } ()
                }],
...
function($) {
    ...
    i = function(e) {
        ...
        return s < i && (e.cols[0].setValue(e.params.minDateTime.split(" ")[0].split("-")[0]), e.cols[1].setValue(e.params.minDateTime.split(" ")[0].split("-")[1]), e.cols[2].setValue(e.params.minDateTime.split(" ")[0].split("-")[2]), e.cols[4].setValue(e.params.minDateTime.split(" ")[1].split(":")[0]), e.cols[6].setValue(e.params.minDateTime.split(" ")[1].split(":")[1]), l = e.params.minDateTime),
        s > r && (e.cols[0].setValue(e.params.maxDateTime.split(" ")[0].split("-")[0]), e.cols[1].setValue(e.params.maxDateTime.split(" ")[0].split("-")[1]), e.cols[2].setValue(e.params.maxDateTime.split(" ")[0].split("-")[2]), e.cols[4].setValue(e.params.maxDateTime.split(" ")[1].split(":")[0]), e.cols[6].setValue(e.params.maxDateTime.split(" ")[1].split(":")[1]), l = e.params.maxDateTime),
        l
    },
    r = {
        rotateEffect: !1,
    ...
    $.fn.dateAndTimePicker = function(e) {
        return this.each(function() {
            if (this) {
                ...
                r),
                n = $.extend(t, e);
                if (n.cssClass = "customized-dateAndTimePicker", n.cols = [{
